                    ...
                    <div class="col-xl-10 col-lg-11 mx-auto login-container">
                        <div class="row">
                            <div class="col-lg-5 col-md-6 no-padding">
                                <div class="register_container">
                                    <form id="register-form" class="form-signin" method="POST">
                                        <div class="login-box">
                                            <h5><span class="text_1_login">Welcome Back <?php echo $row['user_name']?>..!</span></h5>
                                            ...
                                            <div class="login-row row no-margin">
                                                ...
                                                <input type="date" name="user_dob" id="user_dob" class="form-control form-control-sm" value='<?php echo $row['user_dob'] ?>'>
                                            </div>
                            ...
                            <div class="col-lg-7 col-md-6 img-box">
                                <img src="./public/images/loggedin-image.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
